...
python -m umamusume_prompt.mcp.server --http -p 7777
"""
...
try:
    ...
    print("WARNING: Could not import local config. Ensure you run this as a module: python -m umamusume_prompt.mcp.server")
